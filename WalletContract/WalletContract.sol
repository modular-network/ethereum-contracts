 ...
 * The MIT License (MIT)
 * https://github.com/Majoolr/ethereum-contracts/blob/master/LICENSE
 *
 * This is a multisig wallet built using the Majoolr wallet library family at
 * https://github.com/Majoolr/ethereum-libraries/tree/master/WalletLib. Majoolr
 * works on open source projects in the Ethereum community with the purpose of
 * testing, documenting, and deploying reusable code onto the blockchain to
 * improve security and usability of smart contracts. Majoolr also strives to
 * educate non-profits, schools, and other community members about the
...
// Get these from our library repo at https://github.com/Majoolr/ethereum-libraries/tree/master/WalletLib
...
contract WalletContract {
  ...
  function WalletLibTestContract() {
    // Set the address owners, up to 50 allowed
    ...
    // See the library for a detailed list of parameters
