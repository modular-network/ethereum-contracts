 ...
 * TO THE MintedTokenAuction CONTRACT PACKAGED WITH THIS.
 * WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING
 *
 * This contract is a copy of the MintedTokenAuction.sol contract with the
...
contract MintedTokenAuctionTest {
  ...
  function MintedTokenAuctionTest(address _token,
                      ...
                      uint256 _startTime)
  {
    ...
    require(_minimumTokensToSell > 0);
    require(_numberOfTokens > 0 && !err);
    require(_minimumBid > 0 && _lowTokenPrice > 0);
  ...
  function processAuction(string _seed, uint256 _timestamp)
           andIsOwner
           returns (bool ok)
  {
